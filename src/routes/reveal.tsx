    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#faf8f3] via-[#f4e4c1]/20 to-[#d4af37]/10">
        <div className="text-center px-6">
          <p className="text-[#5a1a1a]/60 text-base sm:text-lg mb-4">
            Invalid or missing reveal link
          </p>
          <Link
            to="/"
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16 relative z-10">
        {!revealed ? (
          ...
          <div className="text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="inline-block mb-8 animate-[float_6s_ease-in-out_infinite]">
              <Gift
                className="w-16 h-16 sm:w-24 sm:h-24 mx-auto text-[#d4af37]"
                strokeWidth={1.5}
              />
            </div>

            <h1
              className="text-4xl sm:text-6xl md:text-8xl font-bold text-[#5a1a1a] tracking-tight mb-6 leading-tight"
              style={{ fontFamily: 'Playfair Display, serif' }}
            >
              Hello, {assignment.giver}
            </h1>

            <p className="text-lg sm:text-2xl text-[#5a1a1a]/70 font-light mb-8 sm:mb-12 max-w-2xl mx-auto">
            ...
            <button
              ...
              className="group relative w-full max-w-md sm:w-auto px-8 sm:px-16 py-5 sm:py-8 bg-gradient-to-r from-[#d4af37] via-[#f4e4c1] to-[#d4af37] bg-size-200 text-[#5a1a1a] rounded-2xl sm:rounded-3xl font-bold text-xl sm:text-3xl shadow-2xl shadow-[#d4af37]/50 hover:shadow-[#d4af37]/70 transition-all hover:scale-105 active:scale-95 animate-[glow_3s_ease-in-out_infinite]"
              style={{
          ...
          <div className="text-center animate-in fade-in zoom-in duration-700">
            <div className="mb-8">
              <PartyPopper
                className="w-16 h-16 sm:w-24 sm:h-24 mx-auto text-[#d4af37] animate-in spin-in zoom-in duration-1000"
                strokeWidth={1.5}
              />
            </div>

            <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl shadow-[#5a1a1a]/20 p-6 sm:p-12 md:p-16 border-2 sm:border-4 border-[#d4af37]/30 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              <p
                className="text-xl sm:text-2xl text-[#5a1a1a]/60 mb-6"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
              ...
              <div className="relative inline-block mb-8">
                <h2
                  className="text-4xl sm:text-6xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#8b2f2f] via-[#d4af37] to-[#1a4d2e] tracking-tight leading-tight break-all animate-in fade-in zoom-in duration-1000 delay-500"
                  style={{ fontFamily: 'Playfair Display, serif' }}
                >
                  {assignment.receiver}
                </h2>
              ...
              <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent mx-auto mb-8" />

              <p className="text-base sm:text-xl text-[#5a1a1a]/70 font-light max-w-2xl mx-auto mb-8">
            ...
            {/* Additional info */}
            <div className="mt-8 sm:mt-12 space-y-4 animate-in fade-in duration-1000 delay-700">
        ...
        {revealed && (
          <>
            <div className="hidden md:block absolute top-20 left-20 animate-in fade-in zoom-in duration-1000 delay-500">
              <Sparkles className="w-8 h-8 text-[#d4af37]/40 animate-[float_4s_ease-in-out_infinite]" />
            </div>
            <div className="hidden md:block absolute top-40 right-32 animate-in fade-in zoom-in duration-1000 delay-700">
              <Sparkles className="w-6 h-6 text-[#8b2f2f]/40 animate-[float_5s_ease-in-out_infinite]" />
            </div>
            <div className="hidden md:block absolute bottom-32 left-32 animate-in fade-in zoom-in duration-1000 delay-900">
              <Sparkles className="w-10 h-10 text-[#1a4d2e]/40 animate-[float_6s_ease-in-out_infinite]" />
            </div>
            <div className="hidden md:block absolute bottom-20 right-20 animate-in fade-in zoom-in duration-1000 delay-1000">
